...
export const roleTranslations = {
  pt: {
    ...
    'label.Professor Titular, Associado e Doutor': 'Professores Titulares, Associados e Doutores',
    ...
    'desc.Professor Titular, Associado e Doutor': 'Professores titulares, associados e doutores de universidades e institutos de pesquisa parceiros',
  ...
  en: {
    ...
    'label.Professor Titular, Associado e Doutor': 'Full, Associate, and Assistant Professors',
    ...
    'desc.Professor Titular, Associado e Doutor': 'Full, associate, and assistant professors from partner universities and research institutes',
  ...
  zh: {
    ...
    'label.Professor Titular, Associado e Doutor': '教授、副教授与助理教授',
    ...
    'desc.Professor Titular, Associado e Doutor': '来自合作大学及研究机构的教授、副教授与助理教授',
...
export const pubTranslations = {
  pt: {
    ...
    'ui.search_aria': 'Buscar publicações',
    'ui.filter_year_aria': 'Filtrar por ano',
    'ui.filter_journal_aria': 'Filtrar por periódico',
    'ui.filter_category_aria': 'Filtrar por categoria',
    'ui.sort_aria': 'Ordenar publicações',
    'ui.page_prev_aria': 'Página anterior',
    'ui.page_next_aria': 'Próxima página',
  ...
  en: {
    ...
    'ui.search_aria': 'Search publications',
    'ui.filter_year_aria': 'Filter by year',
    'ui.filter_journal_aria': 'Filter by journal',
    'ui.filter_category_aria': 'Filter by category',
    'ui.sort_aria': 'Sort publications',
    'ui.page_prev_aria': 'Previous page',
    'ui.page_next_aria': 'Next page',
  ...
  zh: {
    ...
    'ui.search_aria': '搜索出版物',
    'ui.filter_year_aria': '按年份筛选',
    'ui.filter_journal_aria': '按期刊筛选',
    'ui.filter_category_aria': '按类别筛选',
    'ui.sort_aria': '排序出版物',
    'ui.page_prev_aria': '上一页',
    'ui.page_next_aria': '下一页',
    'ui.all_years': '所有年份',
