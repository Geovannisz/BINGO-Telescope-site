...
export const ui = {
  pt: {
    ...
    'hero.subtitle': 'O Telescópio BINGO: Mapeando Oscilações Acústicas de Bárions e desvendando a Energia Escura.',
  ...
  en: {
    ...
    'hero.subtitle': 'The BINGO Telescope: Mapping Baryon Acoustic Oscillations and unveiling Dark Energy.',
  ...
  zh: {
    ...
    'hero.title': '探索隐藏的宇宙',
    'hero.subtitle': 'BINGO望远镜：绘制重子声波振荡并揭示暗能量。',
    'hero.cta1': '了解科学',
    'hero.cta2': '最新新闻',
  }
} as const;
