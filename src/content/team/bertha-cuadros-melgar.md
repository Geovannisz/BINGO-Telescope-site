...
motivation: Habilidade com a ferramenta matemática, curiosidade pela física
  ...
  verificarem os modelos teóricos.
years_researching: Desde 1997.
research_lines: Física de buracos negros; Modelos alternativos de Gravitação;
  Aplicações da Conjectura gauge/gravidade.
memorable_experience: >-
  **Positiva:** A abertura da ciência no Brasil que me permite contribuir ao
  conhecimento e à formação de recursos humanos. 


  **Negativa:** A discriminação por ser mulher, que ainda existe em vários grupos de pesquisa no mundo.
project_title: Diversos aspectos da física de buracos negros.
project_description: Estudamos novas soluções de buracos negros que procurem
  resolver problemas que a Relatividade não resolve, analizamos as geodésicas, a
  termodinâmica e a estabilidade dinâmica delas.
project_problem: A modelagem de buracos negros reais, a partir de suposições mais simples.
project_importance: Vivemos uma época em que as ondas gravitacionais têm surgido
  como uma alternativa para observar o universo. Essas observações são
  essenciais para validar os modelos propostos.
project_results: Um resultado bastante interessante é a existência de uma
  correspondência entre os modos quase normais no limite eikonal e a sombra de
  um buraco negro.
project_challenges: O principal desafio é a ferramenta matemática e
  computacional para resolver as equações que surgem dessas pesquisas.
biggest_curiosity: Os buracos negros produzem efeitos muito malucos no
  espaço-tempo em volta deles.
impressive_discovery:  A detecção de ondas gravitacionais.
career_advice: Muita paciência. A ciência não responde uma pergunta a curto
  prazo; existem pesquisas que levam décadas até serem verificadas. O bom é
...
publications:
  ...
  - title: Need of dark energy for dynamical compactification of extra dimensions on
      the brane
  ...
  - title: BTZ-Like String on Codimension-2 Braneworlds in the Thin Brane Limit
    authors: Bertha Cuadros-Melgar, Eleftherios Papantonopoulos, Minas Tsoukalas,
      Vassilios Zamarias
    date: 2008-06-04
  ...
  - title: Stability analysis and area spectrum of three-dimensional Lifshitz black
      holes
  ...
  - title: "Vectorial and spinorial perturbations in Galileon black holes:
    ...
    authors: E. Abdalla, B. Cuadros-Melgar, Jeferson de Oliveira, A. B. Pavan, C. E.
      Pellicer
    date: 2019-02-14
  ...
  - title: Instability of a Reissner-Nordström-AdS black hole under perturbations of
      a scalar field coupled to the Einstein tensor
    authors: E. Abdalla, B. Cuadros-Melgar, R. D. B. Fontana, Jeferson de Oliveira,
      Eleftherios Papantonopoulos, A. B. Pavan
    date: 2019-05-28
  ...
  - pages: "245005"
    authors: Leonardo R. Werneck, Zachariah B. Etienne, Elcio Abdalla, Bertha
      Cuadros-Melgar, C. E. Pellicer
    date: 2021-11-25
    journal: Classical and Quantum Gravity
  ...
  - title: Charged black holes with Yukawa potential
    authors: A. A. Araújo Filho, Kimet Jusufi, B. Cuadros-Melgar, Genly Leon, Abdul
      Jawad, C. E. Pellicer
    date: 2024-12-01
  ...
  - title: Stability of the spacetime of a magnetized compact object
    authors: Eveling C. Ribeiro, L. Formigari, Marcos R. Ribeiro, Elcio Abdalla,
      Bertha Cuadros-Melgar, C. Molina, Amilcar R. de Queiroz, Alberto Saa
    date: 2025-01-15
