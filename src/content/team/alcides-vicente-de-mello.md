...
research_lines: Cosmologia, Física teórica e Astrofísica.
memorable_experience: A cada artigo publicado é um momento marcante, pois é
  quando nós enxergamos que nosso trabalho deu resultado.
project_title: "Estudo do Setor escuro: interação entre matéria escura e energia
  escura; Operational Validation and Beamforming Experiments using the DH-1
  Digital Backend."
...
project_importance: Ao investigar a interação entre matéria e energia escura, o
  ...
  aglomerados.
biggest_curiosity: A maior curiosidade é a própria natureza da matéria escura e
  da energia escura. Sabemos que elas existem, pois, seus efeitos gravitacionais
  moldam o universo, mas não sabemos do que são feitas. É fascinante pensar que
  mais de 95% do universo é composto por algo que ainda não conseguimos ver ou
  identificar diretamente. Meu trabalho busca, especificamente, entender se elas
  interagem e como essa transferência de energia ou momento acontece.
common_myth: 'Uma informação incorreta comum é que a matéria escura é a mesma
  coisa que a energia escura. Na verdade, são entidades completamente distintas:
  a matéria escura age como uma "cola" gravitacional que ajuda a formar as
  estruturas do universo, enquanto a energia escura é a força misteriosa que
  está acelerando a expansão do cosmos. Outro ponto é que, embora o Modelo
  Padrão da Cosmologia (Lambda-CDM) seja muito bem-sucedido, ele ainda não
  explica a natureza dessas duas entidades.'
impressive_discovery: A descoberta mais impressionante e que revolucionou o
  nosso campo foi a da expansão acelerada do universo no final dos anos 90.
  Antes disso, achávamos que a expansão estava desacelerando. Essa descoberta
  inesperada levou à introdução do conceito de energia escura, a força que
  está"empurrando" o universo e fazendo-o se expandir cada vez mais rápido.
career_advice: >-
  O primeiro conselho é cultivar a curiosidade e a paixão pelo desconhecido. A
  ciência é uma jornada de muito trabalho e dedicação, e a motivação intrínseca
  é o que te fará seguir em frente.


  O segundo é a persistência: o caminho da pesquisa tem seus desafios, inclusive financeiros, mas a satisfação de ver o seu trabalho dar resultado a cada artigo publicado é imensurável. Busque se conectar com bons mentores e não tenha medo de se aprofundar nos modelos matemáticos e instrumentais da sua área.
authorized: true
---
