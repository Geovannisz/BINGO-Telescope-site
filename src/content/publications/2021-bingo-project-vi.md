...
summary: "Modelagem da distribuição de ocupação de halos de HI (HOD) e construção de catálogos mock para simulações do BINGO, calibrando a relação entre massa de HI e massa do halo de matéria escura. Desenvolve um framework para gerar realizações mock do campo de HI consistentes com observações existentes."
