...
Logo após, os professores **Élcio Abdalla** e **Filipe Abdalla** apresentaram as perspectivas para as próximas etapas do BINGO, incluindo a evolução da infraestrutura instrumental, o desenvolvimento dos sistemas eletrônicos e o aperfeiçoamento das estratégias de observação. Os pesquisadores ressaltaram que a experiência chinesa em manufatura de precisão, eletrônica avançada e computação de alto desempenho representa um componente essencial para o sucesso das futuras fases do projeto, reforçando o interesse em expandir a cooperação com a USTC na implementação de novas capacidades observacionais.
